        ...
        <table cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th scope="col"><?= $this->Paginator->sort('yearFabrication') ?></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $this->Html->link($this->Html->image($vehicle->brand->brandLogo, ["height"=>"50", "width"=>"50"]), ['controller' => 'Brands', 'action' => 'view', $vehicle->brand->id], array('escape' => false))?></td>
                    <td><?= h($vehicle->modelName) ?></td>
                    <td><?= number_format($vehicle->yearFabrication, 0, ',', ''); ?></td>
                    <td><?= number_format($vehicle->yearModel, 0, ',', ''); ?></td>
                    <td class="actions">
